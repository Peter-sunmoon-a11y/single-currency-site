...
import { useAggregationConfig, useGreatestBets } from "@/hooks/api/usePublic";
...
export const GreatestBets = () => {
  ...
  const { parsedMessages } = useMqttTopicMessagesReadonly(`public/order/greatest`);
  ...
  const mergedMessages = useMemo(() => {
    ...
    const apiList = (greatestBetsResponse?.data ?? []).filter((item: any) => {
  ...
  }, [displayProviderWhitelist, greatestBetsResponse, parsedMessages]);
