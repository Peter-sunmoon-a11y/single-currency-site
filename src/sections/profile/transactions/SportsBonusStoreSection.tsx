...
import { TRANSACTION_PAGE_SIZE, useSportsBonusWalletRecords } from "@/query/transactions";
import { useEffect, useMemo, useState } from "react";
import { PeriodFilter } from "./TransactionFilters";
import { SportsBonusStoreList } from "./TransactionList";
import { extractTransactionPayload, getPeriodTimestamp } from "./_utils";

export function SportsBonusStoreSection() {
  ...
  const { data, isLoading, isFetching } = useSportsBonusWalletRecords(queryParams, { enabled: true });
  ...
  return (
    <>
      ...
      <SportsBonusStoreList transactions={transactions} isLoading={isLoading} isFetching={isFetching} />
