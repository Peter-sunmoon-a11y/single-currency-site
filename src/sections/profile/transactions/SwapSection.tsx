...
import { TRANSACTION_PAGE_SIZE, useSwapRecords } from "@/query/transactions";
...
import { SwapList } from "./TransactionList";
...
export function SwapSection() {
  ...
  const { data, isLoading, isFetching } = useSwapRecords(queryParams, { enabled: true });
    ...
    <>
      ...
      <SwapList
        ...
        onTransactionClick={(tx) => {
          setSelectedDetail(mapDetail({ transaction: tx, transactionType: "Swap" as TransactionType, t }));
