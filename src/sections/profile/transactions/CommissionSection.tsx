...
import { TRANSACTION_PAGE_SIZE, useCommissionRecords } from "@/query/transactions";
...
import { CommissionList } from "./TransactionList";
...
export function CommissionSection() {
  ...
  const { data, isLoading, isFetching } = useCommissionRecords(queryParams, { enabled: true });
    ...
    <>
      ...
      <CommissionList
        ...
        onTransactionClick={(tx) => {
          setSelectedDetail(mapDetail({ transaction: tx, transactionType: "Commission" as TransactionType, t }));
