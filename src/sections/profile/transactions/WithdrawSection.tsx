...
import { TRANSACTION_PAGE_SIZE, useWithdrawRecords } from "@/query/transactions";
...
import { WithdrawList } from "./TransactionList";
...
export function WithdrawSection() {
  ...
  const { data, isLoading, isFetching } = useWithdrawRecords(queryParams, { enabled: true });
    ...
    <>
      ...
      <WithdrawList
        ...
        onTransactionClick={(tx) => {
          setSelectedDetail(mapDetail({ transaction: tx, transactionType: "Withdraw" as TransactionType, t }));
