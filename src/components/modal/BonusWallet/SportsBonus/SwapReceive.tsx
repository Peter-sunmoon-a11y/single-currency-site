...
import { InnerCurrency, InnerDataLabel } from "@/components/modal/BonusWallet/SlotsBonus/SwapReceive.tsx";
          ...
          <div className="flex input border-none outline-none h-12 pr-1 w-full">
            ...
            <div className="flex-shrink-0 flex flex-col gap-2 items-end w-[120px]">
              <div className="px-2 flex items-center justify-between gap-2">
                <img src="/images/bonus_sports/sport.png" className={"w-6 h-6"} alt="" />
